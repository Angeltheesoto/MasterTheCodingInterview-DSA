# Creating a hashtable class in python
class Hashtable:
    def __init__(self):
        """
        ...
        The default load factor of HashMap is 0.75f ( 75% of the map size). Load Factor = (n/k)
        Where n is the number of max number of elements that can be stored dict k is the bucket size.
